...
CX = float(input("\nEnter the x-center of the circular source:\n"))
h = CX*np.pi/(180*3600)
CY = float(input("\nEnter the y-center of the circular source:\n"))
k = CY*np.pi/(180*3600)
...
#    if 0.05<R_S<32 and 0.05e11<m_0<12e11 and 0.8e8<SIGMA_0<17e8 and 1<H_R<7 and 0.05<B<17 and 0.09e10<MASS<1.1e10:
    if -0.2<H<0.2 and -0.2<K<0.2 and SIGMA_0>0:
        return 0.0
    return -np.inf
...
percentage=0.68
#Contours of values
fig = corner.corner(samples, labels=["$h$", r"$k$", r"$\Sigma_0$"],
...
table_para = [r"h",r"k",r"Sigma_0"]
table_units = [r"arcs",r"arcs", r"Solar_Mass/Kpc^2"]
para = [h, k, Sigma_0]
parap68=[h_68pos, k_68pos, Sigma_0_68pos]
paran68=[h_68neg, k_68neg, Sigma_0_68neg]
parap95=[h_95pos, k_95pos, Sigma_0_95pos]
paran95=[h_95neg, k_95neg, Sigma_0_95neg]
index=[r"h",r"k",r"Sigma_0"]
