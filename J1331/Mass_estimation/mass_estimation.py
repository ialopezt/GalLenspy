...
table_data = []
table_para = [r"$M",r"$M_dark",r"$M_bulge",r"$M_disc"]
table_units = [r"solar masses",r"solar masses",r"solar masses",r"solar masses"]
para = [M, M_dark, M_bulge, M_disc]
parap95=[M_pos, M_dark_pos, M_bulge_pos, M_disc_pos]
paran95=[M_neg, M_dark_neg, M_bulge_neg, M_disc_neg]
index=[r"$M",r"$M_dark",r"$M_bulge",r"$M_disc"]
...
print (table_p)
print ("Mass_baryonic=", np.log10(M_bulge+M_disc))
print ("\n#####################################################################")
print ("\nDone")
print ("\n#####################################################################\n")
